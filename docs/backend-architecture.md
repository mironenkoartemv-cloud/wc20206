...
- `shared/third-place-matrix.mjs` — официальная матрица FIFA World Cup 26 Regulations, Annexe C, для распределения восьми лучших третьих мест в 1/16 финала.
- `shared/bracket-topology.mjs` — официальные связи матчей плей-офф и порядок левой/правой стороны сетки.
